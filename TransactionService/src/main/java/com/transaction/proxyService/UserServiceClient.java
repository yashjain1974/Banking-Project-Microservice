...
import com.transaction.dto.UserDto; // DTO representing a User from the User Service

import io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker;
import io.github.resilience4j.retry.annotation.Retry;

/**
 * Feign Client for interacting with the User Microservice.
 * The 'name' should match the 'spring.application.name' of the User Microservice (e.g., "user-service").
 * The 'path' should match the base path of the User Microservice's API (e.g., "/auth").
 */
